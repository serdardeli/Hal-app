...
part 'sevk_etme_for_komisyoncu_state.dart';

class SevkEtmeForKomisyoncuCubit extends Cubit<SevkEtmeForKomisyoncuState> {
  SevkEtmeForKomisyoncuCubit() : super(SevkEtmeForKomisyoncuInitial()) {
  ...
  void activateAutoValidateModeForDriver() {
    ...
    emit(SevkEtmeForKomisyoncuInitial());
  }
  ...
  Future<void> fetchKunyeTransActionsWithNewDate(
    ...
    emit(SevkEtmeForKomisyoncuLoading());
  ...
  Future<void> fetchReferansKunyelerBildirimcininYaptigiWithObject(
    ...
    if (result.error != null) {
      emit(SevkEtmeForKomisyoncuError(message: result.error!.message));
      emit(SevkEtmeForKomisyoncuInitial());
    } else {
  ...
  Future<void> bildirimYap(BuildContext context) async {
    try {
      if (selectedMusteri == null) {
        emit(SevkEtmeForKomisyoncuError(message: "Müşteri Seçiniz"));
        emit(SevkEtmeForKomisyoncuInitial());
        return;
      }
      if (gidecegiYer == null) {
        emit(SevkEtmeForKomisyoncuError(
            message:
      ...
      if (result2.error != null) {
        ...
        if (result2.data.kayitCevapList != null &&
          ...
          if (hasError) {
            ...
            if (isIrsaliye) {
              ...
              if (dbResult.isNotEmpty) {
                ...
                if (token != null) {
                  ...
                  emit(SevkEtmeForKomisyoncuSuccessHasSomeError(
            ...
            if (isIrsaliye) {
              ...
              if (dbResult.isNotEmpty) {
                ...
                if (token != null) {
                  await Future.wait([saveIrsaliye(dbResult, token)]);
                  emit(SevkEtmeForKomisyoncuCompletelySuccess(
                      response: result2.data));
                } else {
                  emit(SevkEtmeForKomisyoncuCompletelySuccess(
                      response: result2.data));
          ...
          //hata
          emit(SevkEtmeForKomisyoncuError(message: "hata"));

          emit(SevkEtmeForKomisyoncuInitial());
        }
      }
    } catch (e) {
      emit(SevkEtmeForKomisyoncuError(message: e.toString()));
      emit(SevkEtmeForKomisyoncuInitial());
    }
  }
  ...
  Future<String?> getToken() async {
    ...
    if (usermodel != null) {
      ...
      if (result.error != null) {
        ...
        emit(SevkEtmeForKomisyoncuError(message: "MySoft hata 1"));
        emit(SevkEtmeForKomisyoncuInitial());
      }
    } else {
      emit(SevkEtmeForKomisyoncuError(
  ...
  void emitError(String message) {
    emit(SevkEtmeForKomisyoncuError(message: message));
