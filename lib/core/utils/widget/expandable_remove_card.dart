...
class ExpansionRemoveCard extends StatefulWidget {
  /// Creates a single-line [ListTile] with a trailing button that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const ExpansionRemoveCard(
      {Key? key,
      this.leading,
      required this.title,
...
class _ExpansionTileState extends State<ExpansionRemoveCard>
                    ...
                    child: ExpandedCardItem(
                      ...
                      suffix: Row(
                        ...
                        children: [
                          ...
                          IconButton(onPressed: widget.removeFunc, icon: Icon(Icons.delete_outline_outlined,size: context.general.mediaSize.width*.09,))
                          //  ElevatedButton(
